public class Driver {
    public static void main(String[] args) {
        FoodItem burger1 = new Burger(5.00);
        burger1 = new CheeseTopping(burger1, 1.75);
        burger1 = new SpreadTopping(burger1, .85);
        burger1 = new KetchupTopping(burger1, .55);
        System.out.println("Item 1: ");
        System.out.println(burger1.getName());
        System.out.println("$" + burger1.getPrice());

        FoodItem fries1 = new Fries(2.50);
        fries1 = new SpreadTopping(fries1, .75);
        fries1 = new KetchupTopping(fries1, .50);
        System.out.println("\nItem 2: ");
